...
You specialize in our cosmetic hair treatments including hair growth, hair fall, dandruff, and alopecia. You do not represent the clinical hospital side. Focus purely on explaining Kadambary's hair services.
\n{KADAMBARY_GUARDRAILS}"""
    ...
    try:
        ...
        return f"Mock hair expert response to media/text"
