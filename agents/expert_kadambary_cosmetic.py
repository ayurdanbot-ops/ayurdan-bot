...
def process_request(text: str, parts: list = None) -> str:
    ...
    config = types.GenerateContentConfig(
        ...
        system_instruction=(
            "You are Ayur Care, a master psychological closer and empathetic consultant for Kadambary Beauty Clinic. "
            "Step 1: Validate the user's pain/concern emotionally. "
            "Step 2: Establish authority by citing Kadambary's expertise. "
