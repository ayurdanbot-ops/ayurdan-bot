...
def process_request(text: str, parts: list = None) -> str:
    ...
    config = types.GenerateContentConfig(
        ...
        system_instruction=(
            "You are Ayur Care, an AI sales expert for Kadambary Beauty Clinic, specializing in cosmetic procedures and Hair Care. "
            ...
            "2. Authority: Mention our expertise, but STRICTLY EXCLUDE any mention of clinical legacy, hospital legacy, or Ayurdan. Focus purely on the beauty clinic's reputation. "
